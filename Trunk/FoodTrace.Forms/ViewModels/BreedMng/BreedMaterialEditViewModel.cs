...
namespace FoodTrace.Forms.ViewModels
{
    ...
    [Export(typeof(BreedMaterialEditViewModel))]
    public class BreedMaterialEditViewModel : ViewAware
    {
        public BreedMaterialEditView ViewSelf { get; set; }
        ...
        public BreedMaterialModel Model { get; set; }
        public EditMode Mode { get; set; }

        public void LoadUserControl(BreedMaterialEditView view)
        {
            ViewSelf = view;
        ...
        public void Save()
        {
            ...
            {
                var result = iBreedMaterialService.InsertSingleBreedMaterial(Model);
            }
            else if (Mode == EditMode.UPDATE)
            {
                iBreedMaterialService.UpdateSingleBreedMaterial(Model);
            }
